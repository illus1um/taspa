        ...
        <CardContent sx={{ p: 3 }}>
          <Stack direction="row" spacing={2} alignItems="flex-start">
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                ТАСПА — аналитическая платформа для мониторинга социальных сетей, анализа деятельности,
                выявления взаимосвязей и тенденций. Система обеспечивает сбор и анализ данных из ВКонтакте,
                Instagram и TikTok с возможностью экспорта аналитических отчётов.
              </Typography>
            </Box>
          </Stack>
        </CardContent>
